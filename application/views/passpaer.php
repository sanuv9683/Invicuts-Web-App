	...
	<div class="container">
		...
		<div class="row">
			<div id="content" class="col col-5 col-lg-5">
				...
				<h1 id="sanu">Passpaper Manager</h1>
				...
				<div class="form-group ">
					...
					<input class="form-control" id="pid" type="text" name="paperID">
				</div>
				<div class="form-group ">
					<label>Enter Paper Name
					</label>
					<input class="form-control" type="text" name="paperName">
				</div>
				<div class="form-group ">
					<label>Choose Paper
					</label>
...
<script type="application/javascript">
	...
	$("#year").change(function () {
		...
		$.ajax({
			...
			for (var index in sub) {
				var ff = sub[index];
				$("#tblMe").append("<tr class='tra'><td>" + ff.papaerID + "</td><td>" + ff.pdfUrl + "</td></tr>");
	...
	function maxID() {
		$.ajax({
			method: "GET",
			url: "<?php echo base_url()?>MaxID/getpmax",
			async: true,
			dataType: "json"
		}).done(function (response) {
			var aa = (response);
